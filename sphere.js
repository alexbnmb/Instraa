document.addEventListener("DOMContentLoaded", function () {
  ...
  class Scene {
    ...
    addCanvas() {
      ...
      document.getElementById("sphere-container").appendChild(canvas);
    }
    ...
    resize() {
      let width = document.getElementById("sphere-container").clientWidth;
      let height = document.getElementById("sphere-container").clientHeight;
